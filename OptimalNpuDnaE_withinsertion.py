...
__usage__ = """
		Find the ideal split point for the splicing of a protein of interest with Npu DnaE, inserting a C at the +1 extein position
		Outpoot: A .txt document with all possible splicing sites (based on structure) sorted from best to worst
		"""
#imports:
import numpy as np
...
#what I need to know from you: input#
Seq=("Put sequence here") #amino acid sequence of your protein of interes
struc=("put structure here") #structure should be added as for example: ["LDADL","KWAR","TIYRLY","LFLKHGK"] (all sequences that are part of Alpha-Helixes and Beta-Sheets)
#end of input#
